...
#define NS_DRAM0_SIZE			ULL(0x240000000)
// #define NS_DRAM1_BASE			ULL(0x140000000)
// #define NS_DRAM1_SIZE			ULL(0x100000000)
...
#define NS_IMAGE_MAX_SIZE		(NS_DRAM0_SIZE - ULL(0x20000000))
